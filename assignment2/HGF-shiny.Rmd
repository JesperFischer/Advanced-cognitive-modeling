...
```{r, fig.height=7}
#nu agent:
obj = c(0.75,0.50,0.25,0.1)

bias = c(0.75,0.70,0.60,0.5)
trials = c(15,15,15,15)
source(paste0(here(),"/assignment2/hgf_agent.R"))

u = rm_agent(bias,trials)

input = data.frame(kappa = 0, theta = 0.5, omega = -2,Inital_prec2 = 4,Inital_mu2 = 0,Inital_mu3 = 0,Inital_prec3 = 4,nu = 0.3)



data = hgf_agent_nu(u = u, u2 = rep(obj,trials), input = input)
