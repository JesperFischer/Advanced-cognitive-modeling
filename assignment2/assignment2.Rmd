...
parameter_recovery = function(ngames,trials){
  ngames = ngames
  trials = trials
  pr = data.frame()
  ...
  plotq = pr %>% ggplot(aes(x = trials, y = mean, col = variable, fill = variable))+
